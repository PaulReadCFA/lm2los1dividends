 ...
 * Integrates with tooltip system for real-time feedback
 */

import { updateTooltipError } from './tooltip.js';
 ...
 * Also updates tooltip with error message
...
export function updateFieldError(fieldId, errorMessage) {
  ...
  if (errorMessage) {
    ...
    updateTooltipError(tooltipId, errorMessage);
    ...
    // Clear tooltip error
    updateTooltipError(tooltipId, null);
  }
}
